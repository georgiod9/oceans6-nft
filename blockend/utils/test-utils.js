 ...
 */
const encodePermitAbiData = w3 => (owner, spender, value, nonce, deadline, name, version, chainId, contractAddress) => {
    ...
    return keccak256(solidityPack(
        ...
        [
            ...
            createAbiEncodedSeparator(
                ...
                [permit_typehash, owner, spender, uint256(w3)(toTokens(w3)(value)), uint256(w3)(nonce), uint256(w3)(deadline)]
            )
        ]
    ));
}
